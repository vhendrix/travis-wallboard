...
(function () {
  ...
  ;
  angular.module('travisWallBoard', ['angular-md5', 'ngRoute', 'travisWallBoard.objects', 'travisWallBoard.filters', 'travisWallBoard.services', 'travisWallBoard.directives', 'travisWallBoard.controllers', 'travisWallBoard.resources']).config(['$routeProvider', 'twsettingsProvider', function ($routeProvider, twsettings) {
