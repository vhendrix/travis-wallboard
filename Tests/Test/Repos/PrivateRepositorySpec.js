...
describe(
  'TestController', function () {
    ...
    describe('Test controller works as a sanity check', function() {
      it('sees if test in scope indeed has the text "Test succesfull"', function() {
        var $scope = {};
        var controller = $controller('TestController', { $scope: $scope });
        expect($scope.test).toEqual('Test succesfull');
      });
      it('sees if the test function indeed retuns the text from the scope "Test succesfull"', function() {
        var $scope = {};
        var controller = $controller('TestController', { $scope: $scope });
        expect($scope.testFunction()).toEqual('Test succesfull');
      });
      it('sees if the set function indeed sets text to the scope', function() {
        var $scope = {};
        var controller = $controller('TestController', { $scope: $scope });
